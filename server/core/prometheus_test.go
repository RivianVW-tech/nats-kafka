...
func TestMetricsEndpoint(t *testing.T) {
	...
	require.Contains(t, metrics, "nats_kafka_bridge_nats_connected 1")
	require.Contains(t, metrics, "nats_kafka_bridge_nats_in_bytes_total")
	require.Contains(t, metrics, "nats_kafka_bridge_nats_out_bytes_total")
...
func TestVarzNATSStats(t *testing.T) {
	...
	require.NotNil(t, bridgeStats.NATS)
	require.True(t, bridgeStats.NATS.Connected)
	require.NotEmpty(t, bridgeStats.NATS.ConnectedURL)
}
